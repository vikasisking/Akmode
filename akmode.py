...
def get_join_channel_message():
    ...
    return (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "<i>Powered by @AkMoDs1Owner And bot dev @hiden_25 ❤️</i>"
    ...
    for otp_entry in fetch_otp_acchubb():
        ...
        if otp_code:
            ...
            msg = (
                ...
                "━━━━━━━━━━━━━━━━━━━━━━\n"
                "⚡️ <i>Powered by @AkMoDs1Owner Bot dev @hiden_25 🔱</i>\n"
                "━━━━━━━━━━━━━━━━━━━━━━"
            )
        ...
        for otp_entry in fetch_otp_acchubb():
            ...
            if otp_code and otp_id not in sent_ids:
                ...
                msg = (
                    ...
                    f"🔑 <b>OTP:</b> <blockquote>{html.escape(otp_code)}</blockquote>\n"
                    "━━━━━━━━━━━━━━━━\n"
                    "⚡️ <i>Powered by @AkMoDs1Owner Bot Dev @hiden_25 ❤️</i>\n"
                    "━━━━━━━━━━━━━━━━━━━"
                )
                send_telegram_message(msg)
...
async def send_number_message(query, data, country_id, carrier_id, changed=False):
    msg = (
        ...
        f"<i>Developed by @AkMoDs1Owner Bot Dev @hiden_25 ❤️</i>"
    )
    keyboard = [
        [
...
async def hiden_25(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    broadcast_message = (
        ...
        "━━━━━━━━━━━━━━━━━━━━━━\n"
        "<i>Powered by @AkMoDs1Owner Bot dev @hiden_25 ❤️</i>"
    )
    sent_count = 0
    failed_count = 0
